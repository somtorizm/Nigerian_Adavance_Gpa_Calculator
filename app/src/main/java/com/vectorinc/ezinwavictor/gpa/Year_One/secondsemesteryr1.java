 ...
 */
public class secondsemesteryr1 extends Fragment {
    ...
    Spinner spinner;
    public static final String SECOND_SEMESTER_YEAR1 = "Second Semester yr1";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        intent = new Intent(getContext(), secondsemesteryr1.class);
