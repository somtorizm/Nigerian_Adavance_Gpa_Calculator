package com.vectorinc.ezinwavictor.gpa.Year_One;
 ...
 */
public class firstsemesteryr1 extends Fragment {
    ...
    Spinner spinner;
    public static final String COURSE_NAME = "yearone_first_semester";
    ...
    public firstsemesteryr1() {


    }


    //ON'CREATE VIEW, WHICH INITIALIZES THE ALL THE VIEWS.
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             final Bundle savedInstanceState) {

        intent = new Intent(getContext(), firstsemesteryr1.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.Preview) {
            ...
            alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    SharedPreferences sharedPref = getContext().getSharedPreferences(COURSE_NAME, MODE_PRIVATE);
        ...
        if (id == R.id.Reset_Saved_Input) {
            ...
            alertDialog.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    SharedPreferences preferences = getContext().getSharedPreferences(COURSE_NAME, MODE_PRIVATE);
                    ...
                    Snackbar.make(view.findViewById(R.id.rootLayout1), "DataBase Cleared Successfully", Snackbar.LENGTH_SHORT).show();
    ...
    private double SpinnerCalculation(Spinner spinner, EditText editTextMultiple) {
        ...
        if ((spinner.getSelectedItem().toString().isEmpty()) && ((editTextMultiple.getText().toString().isEmpty()))) {
            ...
            if (editTextMultiple.getText().toString().isEmpty()) {
                ...
                Toast.makeText(getContext(), "Input Credit Load", Toast.LENGTH_SHORT).show();
            } else {
